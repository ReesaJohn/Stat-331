...
4. Write a function called `shorten()` which takes a vector and keeps dropping the last value, until the sum of the vector is less than 350  Return the remaining values.


```{r}
source("3_Activity_Script.R")
shorten <-function(vector){

  while(sum(vector)>=350){
