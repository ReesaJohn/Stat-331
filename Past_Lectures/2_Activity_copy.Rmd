...
check <- top_secret[top_secret<17]
length(check)
```
...
check2 <- top_secret[500:length(top_secret)]
length(check2[check2>=100])
```
...
checkAgain <- top_secret[top_secret%%2==0]
length(checkAgain)
```
