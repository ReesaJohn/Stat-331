...
```{r}
#fixed kellys and the include = FALSE, and renamed {r plots}, fixed data in lm and switched y and x, kellys_89 didn't edit itselffor ggplot, mutate residuals
kellys = read_delim("./Babyname_Datasets/kellys_ca.txt",delim =" ")
...
We conclude that Kelly is always more popular for girls but its popularity among girls has decreased significantly. As for men, it was never popular but its popularity hasn't decreased by much.
